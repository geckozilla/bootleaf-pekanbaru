...
var subwayLines = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Nama Ruas</th><td>" + feature.properties.Nama_Ruas + "</td></tr>" + "<tr><th>Nomor Ruas</th><td>" + feature.properties.No_Ruas+ "</td></tr>" + "<table>";
      layer.on({
        click: function (e) {
...
$.getJSON("data/jalan_arteri.geojson", function (data) {
...
attributionControl.onAdd = function (map) {
  ...
  div.innerHTML = "<span class='hidden-xs'>Developed by Muhammad Jazman based on <a href='http://bryanmcbride.com'>bryanmcbride.com</a> | </span><a href='#' onclick='$(\"#attributionModal\").modal(\"show\"); return false;'>Attribution</a>";
  return div;
};
...
//agar bisa mencari jalan_arteri
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'>Jalan Arteri</h4>"
    }
